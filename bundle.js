...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/sass-loader/index.js!./_base.scss", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/sass-loader/index.js!./_base.scss");
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ChatBubble = __webpack_require__(228);
	...
	var names = ["brandon", "lindsay", "alex"];
	var affirmative = ['sure', 'yes', 'ya', 'okay', 'ok', 'ye', 'yea', 'yeah', 'yup'];
	var negative = ['no', 'noo', 'nope', 'nop', 'na', 'naw', 'nah', 'pass'];
	...
	var Chat = function (_Component) {
	  ...
	  _createClass(Chat, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      // Start conversation
	      var initialMessages = [{ type: 1, message: "Hello" + (visitor_name ? ' ' + visitor_name : '') + "! ✌🏻" }];

	      window.setTimeout(function () {
	        _this2.setState({ is_typing: true });
	      }, 1000);
	      window.setTimeout(function () {
	        _this2.setState({ is_typing: false });
	        _this2._appendMessage(1, initialMessages[0].message);
	      }, 2000);
	    }
	  }, {
	    ...
	    key: '_popPrevMessage',
	    value: function _popPrevMessage() {
	      var prevState = this.state;
	    ...
	    */
	    ...
	    key: '_respond',
	    value: function _respond(message) {
	      var _this4 = this;

	      console.log("conversation_stage: ", this.state.conversation_stage);
	      window.setTimeout(function () {
	        _this4.setState({ is_typing: true });
	      }, 500);
	      window.setTimeout(function () {
	        // wait before sending the next message
	        // clear typing animation
	        _this4.setState({ is_typing: false });

	        // figure out response
	        // Finite state automata. Thanks Vassos, CSCB36 wasn't a complete waste of time
	        switch (_this4.state.conversation_stage) {

	          // State 0
	          // I do not know you're name yet.
	          case 0:
	            if (!_this4.state.visitor_name) {
	              var timer = 0;
	              _this4._appendMessage(1, "I don't think I've met you before. I'm __Brandon__! And your name is?");
	              _this4.setState({ conversation_stage: -1 });
	              return true;
	            }
	            break;
	          ...
	          case 1:
	            if (message.hasKeyWords(affirmative)) {
	              _this4._appendMessage(1, "Well, I'm a 22 year old software designer and \
	              ...
	              _this4._appendMessage(1, "Maybe you're interested in working together on something? I'm currently accepting projects.");
	              _this4.setState({ conversation_stage: 2 });
	            } else if (message.hasKeyWords(negative)) {
	              _this4._appendMessage(1, "Oh, well maybe you want to see some of my work?");
	              _this4.setState({ conversation_stage: 3 });
	            } else {
	              _this4._appendMessage(1, "I'm not really sure what you mean😕");
	            }
	            break;
	          ...
	          case 2:
	            if (message.hasKeyWords(affirmative)) {
	              _this4._appendMessage(1, "Okay, awesome! Maybe just shoot the real Brandon an email and I'm sure he'd love to help you out.");
	            }
	            break;

	          case 3:
	            _this4._appendMessage(1, _react2.default.createElement(
	              'span',
	              null,
	              'You can see a lot of my code on ',
	              _react2.default.createElement(
	                'a',
	                { href: 'http://github.com/brandonmowat' },
	                'GitHub'
	              ),
	              ' but I also have some live projects too. Would you like to see some of those?'
	            ));
	            break;

	          // I know you're name / You've been here before
	          case 99:
	            _this4._appendMessage(1, "You're looking good today👌🏻");
	            _this4._appendMessage(1, _react2.default.createElement(
	              'span',
	              null,
	              'Would you like to ',
	            ...
	            _this4.setState({ conversation_stage: 100 });
	            break;
	          case 100:
	            if (message.hasKeyPhrases(['something else'])) {
	              _this4._appendMessage(1, "Okay. Are you looking see some of my code? Or did you need to give me a message?");
	              _this4.setState({ conversation_stage: 101 });
	            } else if (message.hasKeyPhrases(['more', 'more about', 'about', 'you'])) {
	              messages.about(_this4);
	            }
	            break;
	          ...
	          case 101:
	            if (message.hasKeyWords(['message', 'second'])) {
	              _this4._appendMessage(1, _react2.default.createElement(
	                'span',
	                null,
	                'I\'m pretty easy to talk to. Just send an email to me ',
	                _react2.default.createElement(
	                  'a',
	                  { href: 'mailto:brandonmowat11@gmail.com' },
	                  'here'
	                ),
	                '.'
	              ));
	          ...
	          case -1:
	            if (message.hasKeyWords(['no', 'na', 'nah', 'nop', 'nope'])) {
	              _this4._appendMessage(1, "Dude, it doesn't even need to be your real name...");
	              _this4.setState({ conversation_stage: -3 });
	            } else if (names.includes(message)) {
	              localStorage.setItem('visitor_name', message);
	              _this4.setState({ visitor_name: message });
	              _this4.setState({ conversation_stage: 1 });
	              _this4._appendMessage(1, "It's nice to meet you " + _this4.state.visitor_name + "!");
	              _this4._appendMessage(1, "Are you here to learn a little bit about who I am and what I do?");
	            } else {
	              _this4.setState({ visitor_name: message });
	              _this4._appendMessage(1, "Wow, " + message + " is a very unique name! Am I spelling it right?");
	              _this4.setState({ conversation_stage: -2 });
	            }
	            break;
	          ...
	          case -2:
	            if (message.hasKeyWords(['yes', 'yep', 'ya', 'yea', 'ye', 'yeah', 'yup'])) {
	              localStorage.setItem('visitor_name', _this4.state.visitor_name);
	              _this4._appendMessage(1, "Nice! It's great to meet you " + _this4.state.visitor_name + "😊");
	              _this4._appendMessage(1, "Are you here to learn a little bit about who I am and what I do?");
	              _this4.setState({ conversation_stage: 1 });
	            } else if (message.hasKeyWords(['no', 'nope', 'nah', 'noo'])) {
	              _this4._appendMessage(1, "Sorry. How do you spell it then?");
	              _this4.setState({ conversation_stage: -3 });
	            }
	            break;
	          ...
	          case -3:
	            localStorage.setItem('visitor_name', message);
	            _this4.setState({ visitor_name: message });
	            _this4._appendMessage(1, "Okay. It's great to meet you " + message + "😊");
	            _this4._appendMessage(1, "Are you here to learn a little bit about who I am and what I do?");
	            _this4.setState({ conversation_stage: 1 });
	            break;
	          default:
	        ...
	        if (message === 'help') {
	          _this4._appendMessage(1, "Try asking one of these:");
	        }
	      }, 2000);
	      //default:
	    }
	    ...
	    value: function _onMessageSubmit(e) {
	      e.preventDefault();
	      if (!this.refs.message_input.value) {
	        return false;
	      }
	      ...
	      return _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                  'p',
	                  { style: { color: "#000000" } },
	                  'You\'re chatting with a little bot I made. ',
	                  _react2.default.createElement('br', null),
	                  'It\'s like me – but a slightly more human.'
	                ),
	                _react2.default.createElement(
	                  'p',
	                  { style: { marginTop: 20 } },
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'form',
	              { ref: 'message_form', onSubmit: this._onMessageSubmit.bind(this) },
	              _react2.default.createElement('input', { ref: 'message_input', placeholder: 'Type a message...' })
	            )
	          )
	        )
	      );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ChatBubble = function (_Component) {
	  ...
	  function ChatBubble(props) {
	    ...
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ChatBubble).call(this));
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/sass-loader/index.js!./_chat_bubble.scss", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/sass-loader/index.js!./_chat_bubble.scss");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".chatbubble {\n  background-color: #03b4f4;\n  border-radius: 1.3em;\n  display: block;\n  float: right;\n  margin: 1px 0;\n  max-width: 425px;\n  padding: 8px 14px; }\n\n.recipient {\n  margin: 10px 0;\n  position: relative; }\n  .recipient img {\n    border-radius: 100px;\n    bottom: 0;\n    left: 0;\n    position: absolute;\n    width: 36px;\n    z-index: 100; }\n  .recipient > .chatbubble {\n    background: rgba(0, 0, 0, 0.05);\n    clear: both;\n    float: left;\n    margin-left: 45px; }\n  .recipient p {\n    color: rgba(0, 0, 0, 0.6); }\n\np {\n  color: #fff;\n  font-size: 16px;\n  font-weight: 300;\n  margin: 0; }\n\na {\n  font-weight: 400;\n  text-decoration: underline; }\n\nstrong {\n  font-weight: 400;\n  text-decoration: underline; }\n", ""]);
...
/***/ function(module, exports) {
	...
	exports.default = String.prototype.hasKeyWords = function (keywords) {
...
/***/ function(module, exports) {
	...
	exports.default = String.prototype.hasKeyPhrases = function (keyphrases) {
